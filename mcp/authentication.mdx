...
The key is the same one the [REST API](/api-reference/authentication) uses,
...
| --- | --- | --- | --- |
| [REST API](/api-reference/authentication) | API key | Workspace | `X-Api-Key` header on each request. |
