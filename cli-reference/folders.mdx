...
into a folder with [`recordings update --folder-id`](/cli-reference/recordings#update-a-recording).
For fields and response details, see the [API reference](/api/folders/list).
