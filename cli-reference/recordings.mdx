...
see the [API reference](/api/recordings/list).
...
[`folders list`](/cli-reference/folders#list-folders).
...
For workspace wide numbers, see [`analytics show`](/cli-reference/analytics#show-workspace-analytics).
